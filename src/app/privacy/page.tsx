    ...
    <main className="w-full flex flex-col items-center justify-center pt-20 pb-32 px-4 relative overflow-hidden bg-gradient-to-b from-gray-950 via-gray-900 to-black">
      ...
      >
        ...
        <p className="text-lg text-gray-300 text-center opacity-90 font-medium mb-8 max-w-2xl font-mono">
          Your privacy is important to us. At Bluffy, we value the trust you place in us and are committed to protecting your privacy.
        </p>

        <p className="text-lg text-gray-300 text-center opacity-90 font-medium mb-4 max-w-2xl font-mono">
          This game is fully open-source, and you are free to copy, modify, or distribute any part of it as per the terms of the open-source license.
        </p>
